...
o.homedir = function() {
    var h = process.popen('echo ~/').read().toString().split('\n')[0];
...
o.tmpdir = function() {
    ...
    if (o.type().toLowerCase().indexOf('windows') != -1) {                                                     //TODO check windows
        trailingSlashRe = /[^:]\\$/;
...
o.networkInterfaces = os.networkInfo;
